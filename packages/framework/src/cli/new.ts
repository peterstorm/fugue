...
> Generated by \`fugue new --from dag.authored.json\`. The STRUCTURE is
> authoritative in \`dag.authored.json\` — edit it and regenerate rather than
> rewiring \`dag.ts\` by hand. Node bodies marked "Placeholder" are yours.
